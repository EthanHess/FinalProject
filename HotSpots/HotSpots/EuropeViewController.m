...
@interface EuropeViewController () <UICollectionViewDelegate>

@property (nonatomic, strong) EuropeViewDataSource *dataSource;
...
- (void)viewDidLoad {
    ...
    self.dataSource = [EuropeViewDataSource new];
